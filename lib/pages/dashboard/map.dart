...
import '../service_provider_signup/dashboard/process/offer.dart';
import '../service_provider_signup/dashboard/process/pricing.dart';

class MapPage extends StatefulWidget {
  ServiceProviderModel? details;
  MapPage({super.key, this.details});
  @override
                  ...
                  Container(
                      child: Padding(
                          ...
                          child: Column(
                            children: [
                              PricingWidget(
                                image: widget.details!.imgurl!,
                                name: widget.details!.name!,
                                min: widget.details!.price!,
                                max: widget.details!.maxprice!,
                              ),
                              const SizedBox(
                                height: 30,
                              ),
                              OfferWidget(serviceProviderModel: widget.details),
                              const SizedBox(
                                height: 10,
                              ),
                              const Text(
