...
import 'package:sosta/pages/service_provider_signup/dashboard/process/pricing.dart';
import 'package:sosta/pages/service_provider_signup/widget/input_widget.dart';

import '../../../constant.dart';
import '../../../widgets/app_button.dart';
import '../../service_provider_signup/dashboard/process/cancel.dart';
import '../../service_provider_signup/dashboard/process/request.dart';
...
class OfferWidgetState extends State<OfferWidget> {
  ...
  callModalTwo() {
    showModalBottomSheet(
        ...
        builder: (context) => OfferPriceWidget(
              show: widget.show,
              model: widget.serviceProviderModel,
            ));
  }
}
...
class OfferPriceWidget extends StatefulWidget {
  ...
  OfferPriceWidget({super.key, this.show = false, this.model});
      ...
      children: [
        Container(
          ...
          child: Column(
            children: [
              PricingWidget(
                image: widget.model!.imgurl!,
                name: widget.model!.name!,
                min: widget.model!.price!,
                max: widget.model!.maxprice!,
              ),
              const SizedBox(
                height: 10,
              ),
              ...
              RequestProcess(model: widget.model!),
              const SizedBox(
                height: 10,
              ),
              Row(
                children: [
                  ...
                  Expanded(
                    child: AppButton(
                        ...
                        left: 10,
                        text:
                            'N${(double.parse(widget.model!.maxprice!) + double.parse(widget.model!.price!)) / 2}',
                        onTap: () {},
                        color: tertiary,
                        bgColor: Color(0xfffFFD9B1)),
                  ),
