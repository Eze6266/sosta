...
import 'package:sosta/components/Navigation/vendor_bottom_nav.dart';
...
class VendorSidebarPage extends StatefulWidget {
  const VendorSidebarPage({super.key});
  @override
  // ignore: library_private_types_in_public_api
  _VendorSidebarPageState createState() => _VendorSidebarPageState();
}

class _VendorSidebarPageState extends State<VendorSidebarPage> {
          ...
          child: Column(
            children: [
              ...
              ListTile(
                ...
                onTap: () => context.go('/provider/dashboard/chat'),
              ),
              const SizedBox(
                height: 15,
              ),
              ListTile(
                ...
                onTap: () => context.go('/provider/dashboard/bookings'),
              ),
              const SizedBox(
                height: 15,
              ),
              ...
              ListTile(
                ...
                onTap: () => context.go('/provider/dashboard/settings'),
              ),
              const SizedBox(
                height: 15,
              ),
